# Story chart data — the format

One YAML file per story: `stories/<slug>.yaml` (the module name and this directory
are still "stories" — the store holds stories, and `expression` says which form).
...
```bash
python3 /home/installer/hermes/projects/alluvial/scripts/story_chart.py <slug>
```

Prints the story's beat/lane counts and which beats carry a rubric category. It
