...
One optional file per chopped-up film: `stories/<slug>-timechart.json`. It carries
...
```bash
python3 /home/installer/hermes/projects/alluvial/scripts/verify_stories.py <slug>-timechart
```
